...
#include <jni.h>
/* Header for class io_sqooba_traildbjava_TrailDBj */

#ifndef _Included_io_sqooba_traildbjava_TrailDBj
#define _Included_io_sqooba_traildbjava_TrailDBj
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     io_sqooba_traildbjava_TrailDBj
 * Method:    tdbConsInit
 ...
 * Signature: (Ljava/nio/ByteBuffer;Lio/sqooba/traildbjava/TrailDBEvent;)I
 */
